...
import static com.marwaeltayeb.das.utils.Constant.CAMERA_PERMISSION_CODE;
import static com.marwaeltayeb.das.utils.Constant.CATEGORY;
import static com.marwaeltayeb.das.utils.Constant.LOCALHOST;
import static com.marwaeltayeb.das.utils.Constant.PRODUCT;
import static com.marwaeltayeb.das.utils.Constant.READ_EXTERNAL_STORAGE_CODE;
import static com.marwaeltayeb.das.utils.ImageUtils.getImageUri;
import static com.marwaeltayeb.das.utils.ImageUtils.getRealPathFromURI;
...
import com.marwaeltayeb.das.databinding.ActivityProductBinding;
import com.marwaeltayeb.das.model.Product;
import com.marwaeltayeb.das.receiver.NetworkChangeReceiver;
import com.marwaeltayeb.das.storage.LoginUtils;
import com.marwaeltayeb.das.utils.FlagsManager;
import com.marwaeltayeb.das.utils.OnNetworkListener;
import com.marwaeltayeb.das.utils.Slide;
import com.marwaeltayeb.das.viewmodel.HistoryViewModel;
import com.marwaeltayeb.das.viewmodel.ProductViewModel;
import com.marwaeltayeb.das.viewmodel.UploadPhotoViewModel;
import com.marwaeltayeb.das.viewmodel.UserImageViewModel;
...
public class ProductActivity extends AppCompatActivity implements View.OnClickListener, OnNetworkListener, ProductAdapter.ProductAdapterOnClickHandler,
    ...
    private ProductAdapter sneakerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.included.content.txtSeeAllSneakers.setOnClickListener(this);
        binding.included.content.txtSeeAllOxfords.setOnClickListener(this);
    ...
    private void setUpViews() {
        ...
        binding.included.content.listOfSneakers.setHasFixedSize(true);
        binding.included.content.listOfSneakers.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        binding.included.content.listOfSneakers.setItemAnimator(null);

        binding.included.content.listOfOxfords.setHasFixedSize(true);
        binding.included.content.listOfOxfords.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        binding.included.content.listOfOxfords.setItemAnimator(null);
        ...
        sneakerAdapter = new ProductAdapter(this, this);
    ...
    private void getSneakers() {
        if (isNetworkConnected(this)) {
            productViewModel.productPagedList.observe(this, products -> sneakerAdapter.submitList(products));

            binding.included.content.listOfSneakers.setAdapter(sneakerAdapter);
        } else {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.txtSeeAllSneakers:
                Intent sneakerIntent = new Intent(this, AllSneakersActivity.class);
                startActivity(sneakerIntent);
                break;
            case R.id.txtSeeAllOxfords:
                Intent oxfordIntent = new Intent(this, AllOxfordsActivity.class);
                startActivity(oxfordIntent);
                break;
    ...
    private void showOrHideViews(int view) {
        binding.included.content.textViewSneakers.setVisibility(view);
        binding.included.content.txtSeeAllSneakers.setVisibility(view);
        binding.included.content.textViewOxfords.setVisibility(view);
        binding.included.content.txtSeeAllOxfords.setVisibility(view);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.nav_sneakers) {
            goToCategoryActivity("Sneaker");
        } else if (id == R.id.nav_oxfords) {
            goToCategoryActivity("Oxford");
        } else if (id == R.id.nav_loafers) {
            goToCategoryActivity("Loafer");
        } else if (id == R.id.nav_boots) {
            goToCategoryActivity("Boot");
